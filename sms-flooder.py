...
logo=f"""
 {byellow}___  __  __  ___      ___  __    __    __  ___  ___  ___  
{byellow}/ __)(  \/  )/ __) ___(  _)(  )  /  \  /  \(   \(  _)(  ,) 
{white}\__ \ )    ( \__ \(___)) _) )(__( () )( () )) ) )) _) )  \ 
{bgreen}(___/(_/\/\_)(___/    (_)  (____)\__/  \__/(___/(___)(_)\_)
"""

meanu=f"""{yellow}
____________________________________________________
{yellow}|\---/{bblue}C{yellow}\---/{bgreen}Y{yellow}\---/{byellow}B{yellow}\---/{bpurple}E{yellow}\---/{white}R{yellow}\------/{bred}D{yellow}\---/{bgreen}K{yellow}\---/|
{white}|-\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /-|
...
{yellow}|                                                  |   
{white}|{cyan}----------------{red}x{cyan}-{red}[{green}3{red}]{cyan}-{white}>{byellow}exit{white}<{cyan}-{red}[{green}3{red}]{cyan}-{red}x{cyan}----------------|   
{green}|__________________________________________________|
"""
